...
class DataTrainingArguments:
    ...
    #do_train: bool = field(
    #    default=False, metadata={"help": "if to do training"}
    #)
...
def main():
    ...
    config = AutoConfig.from_pretrained(
        ...
        bayesian_classifier=True, classifier_prior = "gaussian", 
    )
    # print(config)
    # config.bayesian_classifer = True
    # config.classifer_prior = "gaussian"
    # config.classifier_prior_params = {"loc":0, "scale":1e-2}
    # print(config)
