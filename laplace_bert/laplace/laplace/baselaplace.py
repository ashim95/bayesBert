...
class BaseLaplace:
    ...
    def optimize_prior_precision_base(self, pred_type, method='marglik', n_steps=100, lr=1e-1,
                                      ...
                                      link_approx='probit', n_samples=200, verbose=False,
    ...
    def _gridsearch(self, loss, interval, val_loader, pred_type,
                    link_approx='probit', n_samples=200, loss_with_var=False):
        results = list()
        prior_precs = list()
...
class ParametricLaplace(BaseLaplace):
    ...
    def __call__(self, x, pred_type='glm', link_approx='probit', n_samples=200):
    ...
    def predictive_samples(self, x, pred_type='glm', n_samples=200):
    ...
    def _nn_predictive_samples(self, X, n_samples=200):
        fs = list()
